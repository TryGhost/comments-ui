                        ...
                        <div className="grow-1 w-full">
                            ...
                            >
                                ...
                                <div className="flex items-baseline justify-start">
                                    <button
                                        className={`group flex max-w-[80%] items-center justify-start whitespace-nowrap text-left font-sans text-[14px] tracking-tight text-neutral-400 transition duration-150 hover:text-neutral-500 dark:text-[rgba(255,255,255,0.5)] sm:max-w-[90%] ${!memberExpertise && 'text-neutral-300 hover:text-neutral-400'}`}
                                        onClick={(event) => {
                                            handleShowPopup(event, {
                                        ...
                                        {memberExpertise && <EditIcon className="ml-1 h-[12px] w-[12px] -translate-x-[6px] stroke-neutral-500 opacity-0 transition-all duration-100 ease-out group-hover:translate-x-0 group-hover:opacity-100" />}
                                    </button>
                                </div>
                            </Transition>
                        </div>
